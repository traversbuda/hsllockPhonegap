...
this.$.lockAll.tap(), this.emitClick(), this.value = "lock";
},
emitLockFrontClick: function() {
this.$.lockFront.tap(), this.emitClick(), this.value = "lock-front";
},
emitLockBackClick: function() {
this.$.lockBack.tap(), this.emitClick(), this.value = "lock-back";
},
emitUnlockAllClick: function() {
this.$.unlockAll.tap(), this.emitClick(), this.value = "unlock";
},
emitUnlockFrontClick: function() {
this.$.unlockFront.tap(), this.emitClick(), this.value = "unlock-front";
},
emitUnlockBackClick: function() {
this.$.unlockBack.tap(), this.emitClick(), this.value = "unlock-back";
},
emitOpenFrontClick: function() {
this.$.openFront.tap(), this.emitClick(), this.value = "open-front";
},
emitOpenBackClick: function() {
this.$.openBack.tap(), this.emitClick(), this.value = "open-back";
},
emitToggleClick: function() {
this.$.quickToggle.tap(), this.value = "toggle", this.emitClick();
},
emitClick: function() {
this.bubble("click");
}
...
create: function() {
this.inherited(arguments), this.pamelaItems = [], this.pamelaAjax = new enyo.Ajax({
url: this.url
}), this.updateFromPamela(), setInterval(enyo.bind(this, this.updateFromPamela), 3e4);
},
urlChanged: function() {
this.inherited(arguments), this.rebuild();
},
updateFromPamela: function() {
this.pamelaAjax.response(enyo.bind(this, function(e, t) {
this.rebuild(t);
})), this.pamelaAjax.go();
},
rebuild: function(e) {
this.$.peopleList.destroyComponents();
if (!e) this.pamelaItems[t] = this.$.peopleList.createComponent({
content: "No one... :("
}); else for (var t = 0; t < e.length; t++) /^\./.exec(e[t]) || this.pamelaItems.push(this.$.peopleList.createComponent({
content: e[t]
}));
this.render();
}
...
this.$.urlInput.hasNode().value || (this.$.urlInput.hasNode().value = "http://intranet.heatsynclabs.org/~access/cgi-bin/spaceapi.rb");
var t = this.$.userInput.hasNode().value, n = this.$.passwordInput.hasNode().value, r = this.$.urlInput.hasNode().value;
this.$.errorDiv.setContent("Logging in..."), this.parent.validateData(r, t, n, enyo.bind(this, this.saveData));
},
saveData: function(e, t, n, r) {
e ? (values = [], values.push(n), values.push(r), values.push(t), localStorage.setItem("hsllock_loginData", values.join("|")), this.hide(), this.doLoginChanged()) : this.$.errorDiv.setContent("Login failed, try again!");
}
});
...
rendered: function() {
this.inherited(arguments), this.loadLoginData(), this.getCurrentStatus(), this.jamLock = !0, setInterval(enyo.bind(this, this.getCurrentStatus), 5e3), window.PalmSystem && window.PalmSystem.stageReady();
},
nextState: function() {
this.state === 0 && this.initState();
},
loadLoginData: function() {
var e = localStorage.getItem("hsllock_loginData");
e && (e = e.split("|"), this.username = e[0], this.password = e[1], this.spaceAPIEndpoint = e[2]), this.statusAjaxEndpoint = new enyo.Ajax({
url: this.spaceAPIEndpoint
}), this.statusAjaxEndpoint.response(this, enyo.bind(this, function(e, t) {
this.url = t.apis.oac.url, this.spaceAPIData = t, this.$.pamelaStatus.setUrl(this.spaceAPIData.apis.pamela.url), this.statusRetrieved(e, t);
})), this.statusAjaxEndpoint.go();
},
updateColor: function() {
var e;
this.currentStatus == "1" ? e = "red" : e = "green", document.body.style.backgroundColor = e;
},
getCurrentStatus: function() {
this.statusAjaxEndpoint = new enyo.Ajax({
url: this.spaceAPIEndpoint
}), this.statusAjaxEndpoint.response(this, "statusRetrieved"), this.statusAjaxEndpoint.go();
},
statusRetrieved: function(e, t) {
console.log("got new status.");
var n = t.open ? "0" : "1";
n.length > 0 && (this.currentStatus = n, this.updateColor()), this.jamLock = !0, this.updateColor(), this.$.scrim.hide();
},
lockGroupClick: function(e, t) {
this.sendServerCommand();
},
sendServerCommand: function() {
this.$.scrim.show(), this.currentStatus = this.$.lockGroup.value, this.lockAjaxEndpoint = new enyo.Ajax({
url: this.url
}), this.lockAjaxEndpoint.go({
user: this.username,
pass: this.password,
cmd: this.$.lockGroup.value
}), this.lockAjaxEndpoint.handleAs = "text", this.jamLock = !1;
},
showPopup: function() {
this.$.loginPopup.show();
},
validateData: function(e, t, n, r) {
var i = new enyo.Ajax({
url: e
});
i.response(enyo.bind(this, function(i, s) {
var o = new enyo.Ajax({
url: s.apis.oac.url
});
o.response(enyo.bind(this, function(i, s) {
s.login == "okay" ? r(!0, e, t, n) : r(!1, e, t, n);
})), o.go({
cmd: "check-login",
user: t,
pass: n
